...
OBJS_CONFIG=config.o
OBJS_LIBASKPASS=$(OBJS_CONFIG) libaskpass.o
OBJS_UTIL=$(OBJS_CONFIG) util.o
OBJS_ASKPASS=$(OBJS_CONFIG) $(OBJS_LIBASKPASS) askpass.o
OBJS_ODUS=$(OBJS_CONFIG) $(OBJS_LIBASKPASS) $(OBJS_UTIL) odus.o
OBJS_GGETTY=$(OBJS_CONFIG) $(OBJS_LIBASKPASS) $(OBJS_UTIL) ggetty.o
...
clean:
	rm -fv -- $(OBJS_CONFIG) $(OBJS_LIBASKPASS) $(OBJS_UTIL) $(OBJS_ODUS) $(OBJS_ASKPASS) $(OBJS_GGETTY) $(TARGET_ODUS) $(TARGET_ASKPASS) $(TARGET_GGETTY)
